...
export const metadata: Metadata = {
  title: `${SHOP_NAME} — आमच्याबद्दल व सेवा | विश्वासू मेडिकल स्टोअर`,
  description:
    "आमच्याबद्दल, आमच्या सेवा आणि उपलब्ध उत्पादनांच्या श्रेणी जाणून घ्या. ग्राहकांसाठी आमची बांधिलकी — प्रामाणिक, स्वच्छ आणि सोयीस्कर सेवा.",
};
